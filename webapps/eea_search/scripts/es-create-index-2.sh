curl -u eea:eea -XPUT 'http://centaurus-dev.eea.europa.eu/elasticsearch/_river/search2/_meta' -d '{
  ...
  "eeaRDF" : {
    ...
    "queryType" : "construct",
    "query" : "CONSTRUCT {?s ?p ?o} WHERE {{ ?s a <http://www.eea.europa.eu/portal_types/EEAFigureFile#EEAFigureFile> . ?s ?p ?o} UNION {?s a <http://www.eea.europa.eu/portal_types/EEAVacancy#EEAVacancy> . ?s ?p ?o} UNION {?s a <http://www.eea.europa.eu/portal_types/EcoTip#EcoTip> . ?s ?p ?o} UNION {?s a <http://www.eea.europa.eu/portal_types/EpubFile#EpubFile> . ?s ?p ?o} UNION { ?s a <http://www.eea.europa.eu/portal_types/Event#Event> . ?s ?p ?o} UNION { ?s a <http://www.eea.europa.eu/portal_types/ExternalDataSpec#ExternalDataSpec> . ?s ?p ?o } UNION { ?s a <http://www.eea.europa.eu/portal_types/EyewitnessStory#EyewitnessStory> . ?s ?p ?o } UNION { ?s a <http://www.eea.europa.eu/portal_types/FactSheetDocument#FactSheetDocument> . ?s ?p ?o }}",
