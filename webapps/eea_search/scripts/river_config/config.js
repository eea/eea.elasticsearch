...
var syncConditions = [
    ...
    "{?resource a <http://www.eea.europa.eu/portal_types/DataFile#DataFile>} UNION ",
    ...
    "{?resource a <http://www.eea.europa.eu/portal_types/EpubFile#EpubFile>} UNION ",
    ...
    "{?resource a <http://www.eea.europa.eu/portal_types/EyewitnessStory#EyewitnessStory>} UNION ",
    "{?resource a <http://www.eea.europa.eu/portal_types/FactSheetDocument#FactSheetDocument>} UNION ",
    ...
    "{?resource a <http://www.eea.europa.eu/portal_types/IndicatorFactSheet#IndicatorFactSheet>} UNION ",
    ...
    "{?resource a <http://www.eea.europa.eu/portal_types/SOERMEssage#SOERMEssage>} UNION ",
    "{?resource a <http://www.eea.europa.eu/portal_types/Specification#Specification>} UNION ",
    "{?resource a <http://www.eea.europa.eu/portal_types/Speech#Speech>} UNION ",
    "{?resource a <http://www.eea.europa.eu/portal_types/WorkItem#WorkItem>}"].join('');

var syncTimeProp = "http://cr.eionet.europa.eu/ontologies/contreg.rdf#lastRefreshed";

 
module.exports = {
    'proplist': proplist,
    'listtype': listtype,
    'normalisedProperties': normalisedProperties,
    'blackMap': blackMap,
    'whiteMap': whiteMap,
    'normObj': normObj,
