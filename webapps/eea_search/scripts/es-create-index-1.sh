curl -u eea:eea -XPUT 'http://centaurus-dev.eea.europa.eu/elasticsearch/_river/search1/_meta' -d '{
  ...
  "eeaRDF" : {
    ...
    "queryType" : "construct",
    "query" : "CONSTRUCT {?s ?p ?o} WHERE { {?s a <http://www.eea.europa.eu/portal_types/Assessment#Assessment> . ?s ?p ?o} UNION { ?s a <http://www.eea.europa.eu/portal_types/AssessmentPart#AssessmentPart> . ?s ?p ?o} UNION {?s a <http://www.eea.europa.eu/portal_types/CloudVideo#CloudVideo> . ?s ?p ?o} UNION {?s a <http://www.eea.europa.eu/portal_types/Data#Data> . ?s ?p ?o} UNION {?s a <http://www.eea.europa.eu/portal_types/DataFile#DataFile> . ?s ?p ?o} UNION { ?s a <http://www.eea.europa.eu/portal_types/DavizVisualization#DavizVisualization> . ?s ?p ?o} UNION { ?s a <http://www.eea.europa.eu/portal_types/Document#Document> . ?s ?p ?o }}",
