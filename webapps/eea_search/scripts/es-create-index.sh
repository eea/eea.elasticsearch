#!/bin/bash
curl -u eea:eea -XPUT $1'/_river/search/_meta' -d '{
  "type": "eeaRDF",
  "eeaRDF" : {
    ...
    "proplist" : ["http://purl.org/dc/terms/spatial",
    ...
    "listtype" : "white",
    "normProp" : {"http://www.eea.europa.eu/portal_workflow/daviz_workflow/states/published" : "published",
    ...
    "blackMap" : {"http://www.w3.org/1999/02/22-rdf-syntax-ns#type" : [
                    "Webpage",
                    "Tracked file",
    ...
    "whiteMap" : {"http://purl.org/dc/terms/spatial" : [
    ...
    "normObj" : {"Organisation" : "Organization",
