$(function($) {
  function hide_unused_options() {
    var toHide = ["option1", "Report", "Output from Annual Management Plan", "http://www.eea.europa.eu/portal_types/SimpleVocabularyTerm#SimpleVocabularyTerm", "http://www.eea.europa.eu/portal_types/TreeVocabularyTerm#TreeVocabularyTerm", "http://www.eea.europa.eu/soer/1.0#DataFile", "http://www.eea.europa.eu/soer/1.0#NationalStory", "http://www.eea.europa.eu/portal_vocabularies/themes/climate change", "visible", "undefined"];
  ...
  var facetview_ob = $('.facet-view-simple').facetview({
    ...
    result_display: [],
    add_undefined: true,
    predefined_filters: [{'term': {'language':'fr'}}
    ],
